...
function renderizarInterface(pedido) {
    ...
    if (container) {
        container.innerHTML = itensCozinha.map(item => {
            ...
            return `
                <div class="card-alimento" style="display:flex; align-items:center; background:#fff; margin:20px; padding:15px; border-radius:20px; gap:15px; box-shadow: 0 4px 6px rgba(0,0,0,0.05); border-left: 8px solid #f1a933;">
                    <img src="${imgFinal}" 
